...
export const SwipeCarouselThumbOrder = ({images}: {images: ImageType[]}) => {
  ...
  return (
    ...
    <motion.div className="italic mb-4 flex-1">
      <p className="text-center text-sm">{selected?.description}</p>
    </motion.div>
